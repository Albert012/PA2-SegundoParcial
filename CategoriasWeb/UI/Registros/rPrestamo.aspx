...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <%--<asp:RequiredFieldValidator ValidationGroup="Eliminar" ID="RequiredFieldValidator7" runat="server" ControlToValidate="PrestamoIdTextBox" ErrorMessage="Campo Nombre obligatorio" ForeColor="Red" Display="Dynamic" SetFocusOnError="True" ToolTip="Campo Nombre obligatorio">Por favor llenar el campo Nombre </asp:RequiredFieldValidator>--%>
            </div>
        <%--Fecha--%>
        <div class="form-group col-md-3">
    ...
    <div class="panel-footer">
        <div class="text-center">
            <div class="form-group" style="display: inline-block">
                ...
                <asp:Button Text="Save" ValidationGroup="Guardar" class="btn btn-outline-success btn-md" runat="server" ID="GuadarButton" OnClick="GuadarButton_Click" />
                <asp:Button Text="Delete" ValidationGroup="Eliminar" class="btn btn-outline-danger btn-md" runat="server" ID="EliminarButton" OnClick="EliminarButton_Click" />
